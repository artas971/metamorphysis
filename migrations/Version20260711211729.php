 ...
 */
final class Version20260711211729 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation ADD description_complementaire LONGTEXT DEFAULT NULL, ADD lien_video VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation DROP description_complementaire, DROP lien_video');
