 ...
 */
final class Version20260709201452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page ADD afficher_titre TINYINT DEFAULT 1 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page DROP afficher_titre');
