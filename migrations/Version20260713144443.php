 ...
 */
final class Version20260713144443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE seance (id INT AUTO_INCREMENT NOT NULL, numero INT NOT NULL, duree INT NOT NULL, date_rendez_vous DATETIME DEFAULT NULL, statut VARCHAR(255) NOT NULL, prestation_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_DF7DFD0E9E45C554 (prestation_id), INDEX IDX_DF7DFD0EA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE prestation ADD nombre_seances INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prestation DROP nombre_seances');
