 ...
 */
final class Version20260612223549 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE section (id INT AUTO_INCREMENT NOT NULL, ordre INT NOT NULL, disposition VARCHAR(255) NOT NULL, contenu LONGTEXT DEFAULT NULL, media VARCHAR(255) DEFAULT NULL, page_id INT NOT NULL, INDEX IDX_2D737AEFC4663E4 (page_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
