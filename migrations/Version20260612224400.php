 ...
 */
final class Version20260612224400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section ADD largeur_media INT DEFAULT NULL, ADD hauteur_media INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section DROP largeur_media, DROP hauteur_media');
    }
}
