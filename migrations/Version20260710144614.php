 ...
 */
final class Version20260710144614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section ADD citation_pos_x INT DEFAULT NULL, ADD citation_pos_y INT DEFAULT NULL, ADD citation_largeur INT DEFAULT NULL, ADD citation_couleur_fond VARCHAR(50) DEFAULT NULL, ADD citation_couleur_texte VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section DROP citation_pos_x, DROP citation_pos_y, DROP citation_largeur, DROP citation_couleur_fond, DROP citation_couleur_texte');
